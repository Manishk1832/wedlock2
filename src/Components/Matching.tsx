...
const Matching = () => {
  ...
  />
      ...
      <div className="text-[#4E3A63] py-10 pb-10 px-14  -z-10 ">
        <h1 className="text-4xl md:text-5xl xl:text-6xl font-bold z-10 text-[#4E3A63]" style={{ fontFamily: 'Proxima-Nova-Bold, sans-serif', lineHeight: '89.5px' }}>Exclusive matchmaking</h1>
